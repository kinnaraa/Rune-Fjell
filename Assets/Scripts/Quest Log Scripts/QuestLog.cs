...
public class QuestLog : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            new Quest("Help the Gnome", 1, "In the woods, you hear a voice crying for help in the distance. Navigate the woods, find the voice, and provide aid to the one in trouble.",  new KeyValuePair<Sprite, int>(Resources.Load<Sprite>("UI/Kenaz_Default"), 1)),
            
            /*
            new Quest("Find the Gnome Village", 1, "find gnome village info, blah blah, blah", findVillage),
        ...
        {
            allQuests[i].questObject = gameObject.transform.GetChild(i).gameObject;
            gameObject.transform.GetChild(i).GetChild(0).gameObject.name = allQuests[i].title;
            ...
            Debug.Log(allQuests[i].rewardPairs.Key + "  " + allQuests[i].rewardPairs.Value);
        }
